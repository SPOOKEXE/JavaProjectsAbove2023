...
public class Camera {
	...
	// Constructors //
	public Camera(Vector3 origin, Vector3 lookAt, Vector3 up, float vfov, float aspect_ratio, float aperture,
			float focus_distance) {
		this.setFromValues(origin, lookAt, up, vfov, aspect_ratio, aperture, focus_distance);
	}

	// Methods //
	public void setFromValues(Vector3 origin, Vector3 lookAt, Vector3 up, float vfov, float aspect_ratio,
