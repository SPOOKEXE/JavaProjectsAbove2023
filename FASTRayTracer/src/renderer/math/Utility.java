...
public class Utility {
	...
	public static Vector3 randomColorVec(float min, float max) {
		return new Vector3(Utility.random_float(min, max), Utility.random_float(min, max),
				Utility.random_float(min, max));
	}
	...
	public static Vector3[] LineIntersectAxisAlignedBox(Vector3 rayOrigin, Vector3 rayDirection, Vector3 boxMin,
			Vector3 boxMax) {
